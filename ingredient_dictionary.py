def ingredient_translator(recipe_info):
    ...
    for c1, r in enumerate(recipe_info):  # for each recipe r and its counter c
        for c2, i in enumerate(r['ingredients']):  # for each ingredient of this recipe
            ...
            if i.lower() in ['sea salt', 'seasoning salt', 'salt to taste', 'season salt', 'kosher salt',
            ...
            elif i.lower() in ['salt and pepper', 'salt &amp; pepper', 'large pinch kosher salt &amp; black pepper',
                               'salt and pepper to taste', 'salt and black pepper', 'salt&amp;pepper',
                               'salt and pepper for taste', 'sea salt and freshly ground black pepper',
                               'kosher salt &amp; black pepper', 'kosher salt and black pepper',
                               'salt &amp; pepper to taste', 'kosher salt &amp; freshly cracked black pepper',
                ...
                recipe_info[c1]['ingredients'].extend([u'pepper'])
                               ...
                               'freshly ground pepper', 'black pepper powder', 'black pepper ground']:
            ...
            elif i.lower() in ['ground white pepper']:
                recipe_info[c1]['ingredients'][c2] = u'white pepper'

            elif i.lower() in ['chili']:
                recipe_info[c1]['ingredients'][c2] = u'chili powder'
                               ...
                               'can green chilies', 'green chiles', 'diced green chilis']:
                recipe_info[c1]['ingredients'][c2] = u'green chili'
                               ...
                               'garlic cloves chopped', 'roasted garlic']:
            ...
            elif i.lower() in ['ground ginger', 'fresh ginger']:
                ...
                recipe_info[c1]['ingredients'][c2] = u'rosemary'
                               ...
                               'coriander sedcilantro', 'bundle cilantro; chiffonade']:
                recipe_info[c1]['ingredients'][c2] = u'cilantro'

            elif i.lower() in ['ground coriander seed']:
            ...
            elif i.lower() in ['dried mint', 'mint leaves', 'fresh mint', 'chopped fresh mint']:
            ...
            elif i.lower() in ['ground coriander']:
                recipe_info[c1]['ingredients'][c2] = u'coriander'

            elif i.lower() in ['fresh thyme', 'fresh thyme; minced', 'dry thyme', 'ground thyme',
                               'chopped fresh thyme', '']:
                recipe_info[c1]['ingredients'][c2] = u'thyme'

            elif i.lower() in ['ground cumin', 'cumin powder', 'cumin seeds', 'cumin ground']:
            ...
            elif i.lower() in ['turmeric powder', 'ground turmeric', 'tumeric', 'tumeric powder']:
            ...
            elif i.lower() in ['vegetable broth']:
            ...
            elif i.lower() in ['light soy sauce']:
            ...
            elif i.lower() in ['white vinegar', 'vinegar']:
            ...
            # CARBS
                ...
                recipe_info[c1]['ingredients'][c2] = u'rice'
                               ...
                               'mashed potatoes', 'large russet potatoes']:
            ...
            # VEG
                               ...
                               'medium onions', 'graded onion', 'medium onion, diced']:
                ...
                recipe_info[c1]['ingredients'][c2] = u'lemon juice'
                               ...
                               'lime juiced', 'freshly squeezed lime juice']:
                ...
                recipe_info[c1]['ingredients'][c2] = u'sweetcorn'
                               ...
                               'frozen chopped spinach', 'spinich']:
            ...
            elif i.lower() in ['shredded lettuce', 'chopped lettuce']:
            ...
            elif i.lower() in ['shredded monterey jack cheese']:
            ...
            # MEAT
                ...
                recipe_info[c1]['ingredients'][c2] = u'bacon'
                               ...
                               'ground meat', 'ground beef or turkey']:
            ...
            # NON-INGREDIENTS
                               ...
                               'for the toppings', 'vegetables', 'sauce']:
